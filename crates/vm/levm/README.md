...
We run `EELS`, `ethereum/tests` and `legacyTests` both in their [state](https://github.com/lambdaclass/ethrex-tooling/tree/main/ef_tests/state) and [blockchain](https://github.com/lambdaclass/ethrex-tooling/tree/main/ef_tests/blockchain) form. More info on each README.
